<nav  class="relative w-full flex flex-row-reverse justify-between items-center 2xl:px-6">
    ...
    <div class="flex gap-8 2xl:gap-12 items-center">
        ...
        <x-base.button-link  class="btn-white hidden lg:block " aria_label="Zarezerwuj" href="https://www.booking.com/hotel/pl/willa-pod-scieta-lipa.pl.html">{{__('shared.nav.book')}}</x-base.button-link>
