<div id="menu"
    ...
    <div class="flex justify-center items-center gap-4 absolute left-5 bottom-5 lg:static">
        <a href="" target="_blank"><img src="{{ asset('/assets/icons/facebook.svg') }}" alt="facebook "
                class="w-6 2xl:w-8 hover:scale-90 duration-300 opacity-70" /></a>
        <a href="" target="_blank"><img src="{{ asset('/assets/icons/tripadvisor.svg') }}"
                alt="TripAdvisor " class="w-7 2xl:w-9 hover:scale-90 duration-300 opacity-70" /></a>
    </div>
