    ...
    <div class="max-w-screen-lg mx-4 sm:mx-12   lg:mx-auto pt-6 pb-16 md:py-16 ">
        <div class="grid md:grid-cols-3 gap-12 md:gap-0">
            ...
            <div class="flex flex-col justify-start items-center md:items-end gap-6">
                ...
                <a href="mailto:kontakt@willawzebie.pl" class="text-sm text-fontDark hover-link--white">kontakt@willawzebie.pl</a>
            </div>
        </div>
         {{-- LINKS --}}
...
<a href="https://marketingmix.pl" target="_blank"><img src="{{asset('assets/marketingmix.png')}}" alt="logo wykonawcy - marketingmix.pl" class="w-44 hover:scale-105 duration-300"></a>
 </div>
    </div>
