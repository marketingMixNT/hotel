<nav id="navbar" class="fixed h-[100px] w-full flex  justify-between items-center z-50 opacity-0 bg-white px-4 xs:px-6 sm:px-12">
...
<div>
    ...
    <a href={{ route('home') }} class=" absolute left-4 xs:left-6  sm:left-12  lg:left-1/2 lg:-translate-x-1/2">
        <img src="{{ asset('assets/logo/logo.png') }}" alt="logo Willi pod Ściętą Lipą" class="w-32 sm:w-32" width="128" height="69">
